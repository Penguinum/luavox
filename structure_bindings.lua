...
local function build()
  ...
  table.insert(code_parts, read_file("includes/structure_bindings/sunvox_note.c"))
  local buffer_common = read_file("includes/structure_bindings/buffer.c")
  ...
  table.insert(code_parts, read_file("includes/structure_bindings/buffer_constructor.c"))
